...
export class PurchaseManageService {
    ...
    private resourceUrl = 'api/purchase';
     ...
     * @returns {Observable<ResponseWrapper>}
     */
    create(purchase: Purchase): Observable<ResponseWrapper> {
     ...
     * @returns {Observable<ResponseWrapper>}
     */
    update(purchase: Purchase): Observable<ResponseWrapper> {
     ...
     * @returns {Observable<ResponseWrapper>}
     */
    updatePurchase(id: number, purchaseIds: any): Observable<ResponseWrapper> {
     ...
     */
    private convertItemFromServer(json: any): Purchase {
        const entity: Purchase = Object.assign(new Purchase(), json);
        return entity;
    }
